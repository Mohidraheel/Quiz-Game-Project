...
;level2 
q10 byte "What is the chemical symbol for Gold?", 0
q11 byte "Who developed the theory of relativity?", 0
q12 byte "What is the largest planet in our solar system?", 0
q13 byte "Which element has the atomic number 79?", 0
q14 byte "What is the square root of 256?", 0
q15 byte "Who was the first president of the United States?", 0
q16 byte "What is the capital of Japan?", 0
q17 byte "Which of these is a prime number?", 0
q18 byte "What is the freezing point of water in Fahrenheit?", 0
q19 byte "Which country is known as the Land of the Rising Sun?", 0
